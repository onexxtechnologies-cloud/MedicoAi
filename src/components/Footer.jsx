    ...
    const linkGroups = [
        {
            title: 'Company',
            links: [
                { label: 'Our Mission', path: '#hero' },
                { label: 'Our Team', path: '#hero' },
        ...
        },
        {
            title: 'Solutions',
            links: [
                { label: 'Homeopathic AI', path: '#hero' },
                { label: 'Allopathic AI', path: '#hero' },
                { label: 'Patient Portal', path: '#hero' },
            ]
        },
        {
            title: 'Resources',
            links: [
                { label: 'Medical Blog', path: '#blogs' },
    ...
    return (
        <footer className="footer" id="contact">
            ...
            <div className="footer-content">
                <div className="footer-top-section reveal" ref={el => colsRef.current[0] = el}>
                    <div className="footer-logo-wrapper">
                        <img src="/logo2.png" alt="Medico AI Logo" className="footer-logo" />
                        <div className="footer-brand-text">
                            <span className="footer-brand-name">MEDICO AI</span>
                            <span className="footer-brand-tagline">Healthcare Reinvented</span>
                        </div>
                    </div>
                    <p className="footer-description">
                        Empowering healthcare with advanced AI solutions for both homeopathic and allopathic medicine.
                    </p>
                ...
                <div className="footer-links-container">
                    {linkGroups.map((group, i) => (
                        <div className="footer-col reveal" key={i} ref={el => colsRef.current[i + 1] = el}>
                                ...
                                {group.links.map((link, j) => (
                                    <li key={j} className="footer-item">
                                        <a 
                                            ...
                                            onClick={(e) => link.path.startsWith('#') ? scrollTo(e, link.path.slice(1)) : null}
                                        >
                                            {link.label}
                                        </a>
                                    </li>
